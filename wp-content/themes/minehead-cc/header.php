...
<div id="page" class="hfeed site" style="display:inline">
	...
	<header id="masthead" class="site-header" role="banner" >
		...
		<div id="branding" class="branding-container" style="background: url(<?php echo bloginfo('template_url');?>/theme-images/header-bg-st.png);background-position: center top;">
			<div class="grid">
